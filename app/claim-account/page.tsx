...
export default function ClaimAccountPage() {
  ...
  useEffect(() => {
    ...
    if (!tokenParam) {
      setError("Invalid or missing claim token. Please try logging in again to receive a new link.")
    } else {
      setToken(tokenParam)
    }
  }, [searchParams])
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-8">
            {success ? (
              ...
              <>
                <h1 className="text-2xl font-bold text-center text-[#1a3b4c] mb-2">Claim your account</h1>
                <p className="text-center text-gray-600 mb-6">
                  Set your password to access your account and view your bids.
                </p>
