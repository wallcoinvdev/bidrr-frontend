    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-8 sm:mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-2">
              <span className="font-semibold">Contractors:</span> During our beta period, contractors receive 1 free bid
              per month. After beta, a Bro subscription ($9/month) will include 3 bids per month with refunds for unused
              bids when jobs are not secured. A free tier (1 bid per month) will also be available. Current pricing
          ...
          <section className="mb-8 sm:mb-10">
            ...
            <p className="text-gray-700 leading-relaxed mb-4">
              Bidrr provides a platform for connections between users but is not responsible for disputes between
              customers and contractors. We encourage users to resolve disputes directly.
            </p>
            <p className="text-gray-700 leading-relaxed">
      ...
      <footer className="bg-[#03353a] text-white py-8">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 text-center text-sm text-gray-400">© 2025 Bidrr. All rights reserved.</div>
        </div>
      </footer>
    </div>
  )
